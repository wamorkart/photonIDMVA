...
void evaluateMVA(){
  ...
  string outputFileName = "/eos/user/k/kmondal/public/FLASHgg/PhotonIDMVA/RunIIFall17/MCv2_February2018/February03/Mass95/mvares_Hgg_phoId_94X_EB_Isocorr.root";
  ...
  photonIdMva_sig_->BookMVA( "BDT", "WithIsoCorr/weights/HggPhoId_94X_barrel_BDT.weights.xml");
  photonIdMva_bkg_->BookMVA( "BDT", "WithIsoCorr/weights/HggPhoId_94X_barrel_BDT.weights.xml");
